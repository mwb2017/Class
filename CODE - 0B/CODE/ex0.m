...
%
%%
% Written By: Paola G. Pittoni | Spencer Pfeifer
% Date:   08/17/20
%
%#ok<*UNRCH>
...
disp(' ');
fprintf('  CHECK: Does your plot match Fig. 2 in the MATLAB tutorial?\n')
...
fprintf('  CHECK: Does your plot match Fig. 3 in the MATLAB tutorial?\n\n')
cprintf('*comments', '>> DONE.\n');
...
fprintf('  \n\nCHECK: Does your plot match Fig. 4 in the MATLAB tutorial?\n\n')
